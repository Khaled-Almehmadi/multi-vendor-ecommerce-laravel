...
{
    if ($request->isMethod('post')) {
         $Status = $this->adminService->updateDetails($request);
...
public function deleteProfileImage(Request $request){
    ...
    $data = $request->all();
    $status = $this->adminService->deleteProfileImage($data);
...
public function deleteSubadmin( $id){
    ...
    $status = $this->adminService->deleteSubadmin($id);

    return redirect()->back()->with('success_message',$status['message']);
}
...
public function addEditSubadminRequest(SubadminRequest $request) {
    if ($request->isMethod('post')) {
        ...
        return redirect('admin/subadmins')->with('success_message',
        $result['message']);
    }
}

                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header">
                         ...
                         <a style="max-width: 150px; float: right; display: inline-block;" href="{{ url('admin/add-edit-subadmin') }}" class="btn btn-block btn-primary">
        Add Sub Admin
    </a>
                        </div>
                        <div class="card-body">
                            ...
                            <table id="subadmins" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                 ...
                                 <td>
                                        ...
                                        &nbsp;&nbsp;<a class="confirmDelete" data-id="{{$subadmin->id}}" data-modlue="subadmin" name="Subadmin" style =' color:#3f6ed3;'title="Delete Subadmin" ><i class="fas fa-trash"></i></a>
